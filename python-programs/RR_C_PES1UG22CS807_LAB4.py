...
class SVM:
    ...
    def build_models(self):
        ...
        model1 =  Pipeline([("scalar",StandardScaler()),("regressor",SVR(kernel='linear',gamma=0.1))])



        model2 = Pipeline([("scalar",StandardScaler()),("classifier",SVC(kernel='rbf',C=1,gamma=0.1))])


        model3 =Pipeline([("scalar",StandardScaler()),("classifier",SVC(kernel='rbf',C=1,gamma=0.1))])
