...
void myinit()
{
	GLfloat mat_specular[] = { 0.5, 0.2, 0.0, 1.0 }; // Brown specular color
	GLfloat mat_diffuse[] = { 0.8, 0.3, 0.0, 1.0 };  // Brown diffuse color
	GLfloat mat_ambient[] = { 0.5, 0.2, 0.0, 1.0 };  // Brown ambient color
